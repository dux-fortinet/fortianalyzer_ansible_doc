:source: faz_dvm_cmd_del_devlist.py

:orphan:

.. _faz_dvm_cmd_del_devlist:
...
.. raw:: html
 ...
 <li><span class="li-head">dvm_cmd_del_devlist</span> - Delete a list of devices. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">del_dev_member_list</span> - No description for the parameter <span class="li-normal">type: list of dict</span>
 ...
 <li><span class="li-head">flags</span> - No description for the parameter <span class="li-normal">type: list</span> <span class="li-normal">choices: [none, create_task, nonblocking]</span>  <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Delete a list of devices.
        fortinet.fortianalyzer.faz_dvm_cmd_del_devlist:
          dvm_cmd_del_devlist:
            adom: root
            del_dev_member_list:
              - name: foodevice
