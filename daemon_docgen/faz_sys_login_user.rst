...
.. raw:: html
 ...
 <li><span class="li-head">user</span> - No description for the parameter <span class="li-normal">type: str</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Log into the device with user name and password.
        fortinet.fortianalyzer.faz_sys_login_user:
          sys_login_user:
            passwd: "ca$hc0w"
            user: admin
    vars:
