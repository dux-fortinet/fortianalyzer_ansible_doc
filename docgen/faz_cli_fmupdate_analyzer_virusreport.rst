:source: faz_cli_fmupdate_analyzer_virusreport.py

:orphan:

.. _faz_cli_fmupdate_analyzer_virusreport:
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Send virus detection notification to FortiGuard.
        fortinet.fortianalyzer.faz_cli_fmupdate_analyzer_virusreport:
