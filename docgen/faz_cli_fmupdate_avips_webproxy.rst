:source: faz_cli_fmupdate_avips_webproxy.py

:orphan:

.. _faz_cli_fmupdate_avips_webproxy:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_fmupdate_avips_webproxy</span> - Configure the web proxy for use with FortiGuard antivirus and IPS updates. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
