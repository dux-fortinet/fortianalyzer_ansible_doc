:source: faz_cli_fmupdate_diskquota.py

:orphan:

.. _faz_cli_fmupdate_diskquota:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_fmupdate_diskquota</span> - Configure disk space available for use by the Upgrade Manager. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">value</span> - Configure the size of the Upgrade Manager disk quota, in megabytes. <span class="li-normal">type: int</span>  <span class="li-normal">default: 51200</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Configure disk space available for use by the Upgrade Manager.
        fortinet.fortianalyzer.faz_cli_fmupdate_diskquota:
