:source: faz_cli_fmupdate_fdssetting_serveroverride.py

:orphan:

.. _faz_cli_fmupdate_fdssetting_serveroverride:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_fmupdate_fdssetting_serveroverride</span> - Server override configure. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">service_type</span> - Override service type. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [fct, fds]</span>  <span class="li-normal">default: fds</span>  <a id='label10' href="javascript:ContentClick('label11', 'label10');" onmouseover="ContentPreview('label11');" onmouseout="ContentUnpreview('label11');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Server override configure.
        fortinet.fortianalyzer.faz_cli_fmupdate_fdssetting_serveroverride:
