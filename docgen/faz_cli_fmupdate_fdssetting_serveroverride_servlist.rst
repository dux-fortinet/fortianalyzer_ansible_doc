:source: faz_cli_fmupdate_fdssetting_serveroverride_servlist.py

:orphan:

.. _faz_cli_fmupdate_fdssetting_serveroverride_servlist:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_fmupdate_fdssetting_serveroverride_servlist</span> - Override server. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">service_type</span> - Override service type. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [fct, fds]</span>  <span class="li-normal">default: fds</span>  <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Override server.
        fortinet.fortianalyzer.faz_cli_fmupdate_fdssetting_serveroverride_servlist:
