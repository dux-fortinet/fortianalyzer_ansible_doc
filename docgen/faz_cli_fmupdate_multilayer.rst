:source: faz_cli_fmupdate_multilayer.py

:orphan:

.. _faz_cli_fmupdate_multilayer:
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Configure multilayer mode.
        fortinet.fortianalyzer.faz_cli_fmupdate_multilayer:
