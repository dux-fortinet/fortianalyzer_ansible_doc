:source: faz_cli_fmupdate_serveroverridestatus.py

:orphan:

.. _faz_cli_fmupdate_serveroverridestatus:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_fmupdate_serveroverridestatus</span> - Configure strict/loose server override. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">mode</span> - Server override mode (default = loose). <span class="li-normal">type: str</span>  <span class="li-normal">choices: [strict, loose]</span>  <span class="li-normal">default: loose</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Configure strict/loose server override.
        fortinet.fortianalyzer.faz_cli_fmupdate_serveroverridestatus:
