:source: faz_cli_fmupdate_service.py

:orphan:

.. _faz_cli_fmupdate_service:
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Enable/disable services provided by the built-in FortiGuard.
        fortinet.fortianalyzer.faz_cli_fmupdate_service:
