:source: faz_cli_system_admin_group.py

:orphan:

.. _faz_cli_system_admin_group:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_admin_group</span> - User group. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <ul class="ul-self">
 <li><span class="li-head">name</span> - Group member name. <span class="li-normal">type: str</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Create user group.
        fortinet.fortianalyzer.faz_cli_system_admin_group:
  ...
  - name: Example playbook
    ...
    tasks:
      ...
      - name: Delete group members.
        fortinet.fortianalyzer.faz_cli_system_admin_group_member:
