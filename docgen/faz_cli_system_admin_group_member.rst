:source: faz_cli_system_admin_group_member.py

:orphan:

.. _faz_cli_system_admin_group_member:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_admin_group_member</span> - Group members. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">name</span> - Group member name. <span class="li-normal">type: str</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
