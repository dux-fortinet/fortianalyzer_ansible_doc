:source: faz_cli_system_admin_ldap_adom.py

:orphan:

.. _faz_cli_system_admin_ldap_adom:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_admin_ldap_adom</span> - Admin domain. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Admin domain.
        fortinet.fortianalyzer.faz_cli_system_admin_ldap_adom:
