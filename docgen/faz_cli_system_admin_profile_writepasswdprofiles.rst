:source: faz_cli_system_admin_profile_writepasswdprofiles.py

:orphan:

.. _faz_cli_system_admin_profile_writepasswdprofiles:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_admin_profile_writepasswdprofiles</span> - Profile list. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">profileid</span> - Profile ID. <span class="li-normal">type: str</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Profile list.
        fortinet.fortianalyzer.faz_cli_system_admin_profile_writepasswdprofiles:
