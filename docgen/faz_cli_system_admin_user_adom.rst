:source: faz_cli_system_admin_user_adom.py

:orphan:

.. _faz_cli_system_admin_user_adom:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_admin_user_adom</span> - Admin domain. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Create admin domain.
        fortinet.fortianalyzer.faz_cli_system_admin_user_adom:
          cli_system_admin_user_adom:
            adom_name: root
          state: present
          user: fooadminuser
      - name: Delete admin domain.
        fortinet.fortianalyzer.faz_cli_system_admin_user_adom:
          user: fooadminuser
          state: "absent"
          cli_system_admin_user_adom:
