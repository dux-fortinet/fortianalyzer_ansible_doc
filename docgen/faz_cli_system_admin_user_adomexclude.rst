:source: faz_cli_system_admin_user_adomexclude.py

:orphan:

.. _faz_cli_system_admin_user_adomexclude:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_admin_user_adomexclude</span> - Excluding admin domain. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">adom_name</span> - Admin domain names. <span class="li-normal">type: str</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Excluding admin domain.
        fortinet.fortianalyzer.faz_cli_system_admin_user_adomexclude:
