:source: faz_cli_system_admin_user_restrictdevvdom.py

:orphan:

.. _faz_cli_system_admin_user_restrictdevvdom:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_admin_user_restrictdevvdom</span> - Restricted to these devices/VDOMs. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">dev_vdom</span> - Device or device VDOM. <span class="li-normal">type: str</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
