:source: faz_cli_system_autodelete_logautodeletion.py

:orphan:

.. _faz_cli_system_autodelete_logautodeletion:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_autodelete_logautodeletion</span> - Automatic deletion policy for device logs. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Automatic deletion policy for device logs.
        fortinet.fortianalyzer.faz_cli_system_autodelete_logautodeletion:
