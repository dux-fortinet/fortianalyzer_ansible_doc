:source: faz_cli_system_autodelete_quarantinefilesautodeletion.py

:orphan:

.. _faz_cli_system_autodelete_quarantinefilesautodeletion:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_autodelete_quarantinefilesautodeletion</span> - Automatic deletion policy for quarantined files. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Automatic deletion policy for quarantined files.
        fortinet.fortianalyzer.faz_cli_system_autodelete_quarantinefilesautodeletion:
