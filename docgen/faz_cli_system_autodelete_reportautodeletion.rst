:source: faz_cli_system_autodelete_reportautodeletion.py

:orphan:

.. _faz_cli_system_autodelete_reportautodeletion:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_autodelete_reportautodeletion</span> - Automatic deletion policy for reports. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Automatic deletion policy for reports.
        fortinet.fortianalyzer.faz_cli_system_autodelete_reportautodeletion:
