:source: faz_cli_system_certificate_local.py
...
.. raw:: html
 ...
 <li><span class="li-head">private_key</span> - No description for the parameter <span class="li-normal">type: str</span> <a id='label10' href="javascript:ContentClick('label11', 'label10');" onmouseover="ContentPreview('label11');" onmouseout="ContentUnpreview('label11');" title="click to collapse or expand..."> more... </a>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Create local keys and certificates.
        fortinet.fortianalyzer.faz_cli_system_certificate_local:
          ...
          state: present
      - name: Delete local keys and certificates.
        fortinet.fortianalyzer.faz_cli_system_certificate_local:
          state: "absent"
          cli_system_certificate_local:
            name: foolocal
