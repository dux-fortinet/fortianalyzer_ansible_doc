:source: faz_cli_system_fips.py

:orphan:

.. _faz_cli_system_fips:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_fips</span> - Settings for FIPS-CC mode. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Settings for FIPS-CC mode.
        fortinet.fortianalyzer.faz_cli_system_fips:
          cli_system_fips:
