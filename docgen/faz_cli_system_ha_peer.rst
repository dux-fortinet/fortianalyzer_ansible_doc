:source: faz_cli_system_ha_peer.py

:orphan:

.. _faz_cli_system_ha_peer:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_ha_peer</span> - Peers. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">ip</span> - IP address of peer for management and data. <span class="li-normal">type: str</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 <div id="label3" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.2.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">ip_hb</span> - IP address of peers VIP interface for heartbeat, set if different from ip. (needed only when using unicast) <span class="li-normal">type: str</span>  <a id='label4' href="javascript:ContentClick('label5', 'label4');" onmouseover="ContentPreview('label5');" onmouseout="ContentUnpreview('label5');" title="click to collapse or expand..."> more... </a>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Peers.
        fortinet.fortianalyzer.faz_cli_system_ha_peer:
          cli_system_ha_peer:
            id: 0
            ip: 2.33.4.55
            # ip_hb: <value of string>
            serial_number: FLVMS4713869145
            status: disable
          state: present
    vars:
