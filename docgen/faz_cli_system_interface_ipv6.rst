...
.. raw:: html
 ...
 <li><span class="li-head">ip6_allowaccess</span> - No description for the parameter <span class="li-normal">type: list</span> <span class="li-normal">choices: [ping, https, ssh, snmp, http, webservice, fgfm, https-logging, fabric]</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: IPv6 of interface.
        fortinet.fortianalyzer.faz_cli_system_interface_ipv6:
