:source: faz_cli_system_locallog_fortianalyzer3_setting.py

:orphan:

.. _faz_cli_system_locallog_fortianalyzer3_setting:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_locallog_fortianalyzer3_setting</span> - Settings for locallog to fortianalyzer. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Settings for locallog to fortianalyzer.
        fortinet.fortianalyzer.faz_cli_system_locallog_fortianalyzer3_setting:
