:source: faz_cli_system_locallog_syslogd3_setting.py

:orphan:

.. _faz_cli_system_locallog_syslogd3_setting:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_locallog_syslogd3_setting</span> Settings for remote syslog server. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Settings for remote syslog server.
        fortinet.fortianalyzer.faz_cli_system_locallog_syslogd3_setting:
