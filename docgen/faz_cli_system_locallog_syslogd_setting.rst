:source: faz_cli_system_locallog_syslogd_setting.py

:orphan:

.. _faz_cli_system_locallog_syslogd_setting:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_locallog_syslogd_setting</span> Settings for remote syslog server. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
