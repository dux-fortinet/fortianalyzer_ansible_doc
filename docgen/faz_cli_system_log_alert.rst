:source: faz_cli_system_log_alert.py

:orphan:

.. _faz_cli_system_log_alert:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_log_alert</span> - Log based alert settings. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Log based alert settings.
        fortinet.fortianalyzer.faz_cli_system_log_alert:
