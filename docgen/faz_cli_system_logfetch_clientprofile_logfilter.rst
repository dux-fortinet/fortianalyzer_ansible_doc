:source: faz_cli_system_logfetch_clientprofile_logfilter.py

:orphan:

.. _faz_cli_system_logfetch_clientprofile_logfilter:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_logfetch_clientprofile_logfilter</span> - Log content filters. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">field</span> - Field name. <span class="li-normal">type: str</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Log content filters.
        fortinet.fortianalyzer.faz_cli_system_logfetch_clientprofile_logfilter:
