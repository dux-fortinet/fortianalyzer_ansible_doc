:source: faz_cli_system_logforwardservice.py

:orphan:

.. _faz_cli_system_logforwardservice:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_logforwardservice</span> - Log forwarding service. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">accept_aggregation</span> - Enable/disable accept log aggregation option. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [disable, enable]</span>  <span class="li-normal">default: disable</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.2.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">aggregation_disk_quota</span> - Aggregated device disk quota (MB) on server. <span class="li-normal">type: int</span>  <span class="li-normal">default: 20000</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Log forwarding service.
        fortinet.fortianalyzer.faz_cli_system_logforwardservice:
