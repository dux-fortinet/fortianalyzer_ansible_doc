:source: faz_cli_system_snmp_community_hosts6.py

:orphan:

.. _faz_cli_system_snmp_community_hosts6:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_snmp_community_hosts6</span> - Allow hosts configuration for IPv6. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">ip</span> - Allow host IP address. <span class="li-normal">type: str</span>  <span class="li-normal">default: ::/0</span>  <a id='label4' href="javascript:ContentClick('label5', 'label4');" onmouseover="ContentPreview('label5');" onmouseout="ContentUnpreview('label5');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Allow hosts configuration for IPv6.
        fortinet.fortianalyzer.faz_cli_system_snmp_community_hosts6:
