:source: faz_eventmgmt_alerts_assign.py

:orphan:

.. _faz_eventmgmt_alerts_assign:
...
.. raw:: html
 ...
 <li><span class="li-head">eventmgmt_alerts_assign</span> Assign alert events <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">assign_to</span> assign the alert to the user <span class="li-normal">type: str</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Assign alert events
        fortinet.fortianalyzer.faz_eventmgmt_alerts_assign:
          # bypass_validation: false
          # rc_succeeded: [0, -2, -3, ...]
          # rc_failed: [-2, -3, ...]
          adom: <your own value>
          eventmgmt_alerts_assign:
            alertid: <value of string>
            assign_to: <value of string>
