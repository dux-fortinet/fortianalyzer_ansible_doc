:source: faz_eventmgmt_alerts_read.py

:orphan:

.. _faz_eventmgmt_alerts_read:
...
.. raw:: html
 ...
 <li><span class="li-head">eventmgmt_alerts_read</span> Mark a specific alert event as read. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Mark a specific alert event as read.
        fortinet.fortianalyzer.faz_eventmgmt_alerts_read:
