:source: faz_eventmgmt_alerts_unack.py

:orphan:

.. _faz_eventmgmt_alerts_unack:
...
.. raw:: html
 ...
 <li><span class="li-head">eventmgmt_alerts_unack</span> Unacknowledge alert events. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">update_by</span> The user perform the operation. <span class="li-normal">type: str</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Unacknowledge alert events.
        fortinet.fortianalyzer.faz_eventmgmt_alerts_unack:
