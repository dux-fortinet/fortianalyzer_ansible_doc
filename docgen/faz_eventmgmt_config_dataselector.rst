:source: faz_eventmgmt_config_dataselector.py

:orphan:

.. _faz_eventmgmt_config_dataselector:
...
.. raw:: html
 ...
 <li><span class="li-head">eventmgmt_config_dataselector</span> Config data-selector. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">address_filter</span> reference: /alert/data-selector/address-filter <span class="li-normal">type: list of dict</span>
 ...
 <li><span class="li-head">device</span> reference: /alert/data-selector/device <span class="li-normal">type: list of dict</span>
 ...
 <li><span class="li-head">device_specify</span> <span class="li-normal">type: raw</span>  <span class="li-normal">choices: [0: all-devices, 1: local-hos, 2: specify]</span>  <a id='label4' href="javascript:ContentClick('label5', 'label4');" onmouseover="ContentPreview('label5');" onmouseout="ContentUnpreview('label5');" title="click to collapse or expand..."> more... </a>
 ...
 <li><span class="li-head">rule</span> reference: /alert/data-selector/rule <span class="li-normal">type: list of dict</span>
 ...
 <li><span class="li-head">selector_id</span> <span class="li-normal">type: str</span>  <a id='label10' href="javascript:ContentClick('label11', 'label10');" onmouseover="ContentPreview('label11');" onmouseout="ContentUnpreview('label11');" title="click to collapse or expand..."> more... </a>
 <div id="label11" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.2 -> v7.4.2</code>, <code class="docutils literal notranslate">v7.6.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">subnet_scope</span> <span class="li-normal">type: int</span>  <span class="li-normal">choices: [0: both, 1: source, 2: destination]</span>  <span class="li-normal">default: 0</span>  <a id='label12' href="javascript:ContentClick('label13', 'label12');" onmouseover="ContentPreview('label13');" onmouseout="ContentUnpreview('label13');" title="click to collapse or expand..."> more... </a>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Config data-selector.
        fortinet.fortianalyzer.faz_eventmgmt_config_dataselector:
