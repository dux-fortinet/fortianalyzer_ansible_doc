:source: faz_eventmgmt_config_trigger_device.py

:orphan:

.. _faz_eventmgmt_config_trigger_device:
...
.. raw:: html
 ...
 <li><span class="li-head">eventmgmt_config_trigger_device</span> Device <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">type</span> <span class="li-normal">type: raw</span>  <span class="li-normal">choices: [log-device, all-devices, log-group]</span>  <a id='label4' href="javascript:ContentClick('label5', 'label4');" onmouseover="ContentPreview('label5');" onmouseout="ContentUnpreview('label5');" title="click to collapse or expand..."> more... </a>
