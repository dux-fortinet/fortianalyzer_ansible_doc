:source: faz_eventmgmt_mitreattackmatrix.py

:orphan:

.. _faz_eventmgmt_mitreattackmatrix:

faz_eventmgmt_mitreattackmatrix -- Get Mitre Attack matrix.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">eventmgmt_mitreattackmatrix</span> Get Mitre Attack matrix. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">option</span> The option of the return data. Metadata is to include the technique name, url and description. Event-count, incident-count and handler-count is to include the statistic of each category. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [metadata, event-count, incident-count, handler-count]</span>  <span class="li-normal">default: metadata</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Get Mitre Attack matrix.
        fortinet.fortianalyzer.faz_eventmgmt_mitreattackmatrix:
          # bypass_validation: false
          # rc_succeeded: [0, -2, -3, ...]
          # rc_failed: [-2, -3, ...]
          adom: <your own value>
          eventmgmt_mitreattackmatrix:
