:source: faz_eventmgmt_mitreattackmatrix_technique.py

:orphan:

.. _faz_eventmgmt_mitreattackmatrix_technique:

faz_eventmgmt_mitreattackmatrix_technique -- Get Mitre Attack matrix by technique id
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">techid</span> The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">eventmgmt_mitreattackmatrix_technique</span> Get Mitre Attack matrix by technique id <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">mitre_domain</span> Query mitre domain, either enterprise or ics. <span class="li-normal">type: str</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">option</span> The option of the return data. Metadata is to include the technique name, url and description. Event-count, incident-count and handler-count is to include the statistic of each category. Event-summary, incident-summary and handler-summary is to include the summary data for the given tehcnique id <span class="li-normal">type: str</span>  <span class="li-normal">choices: [metadata, event-count, incident-count, handler-count, event-summary, incident-summary, handler-summary]</span>  <span class="li-normal">default: metadata</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 <div id="label3" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">time_range</span> <span class="li-normal">type: dict</span>
 <a id='label4' href="javascript:ContentClick('label5', 'label4');" onmouseover="ContentPreview('label5');" onmouseout="ContentUnpreview('label5');" title="click to collapse or expand..."> more... </a>
 <div id="label5" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.1 -> latest</code></p>
 </div>
 <ul class="ul-self">
 <li><span class="li-head">end</span> The end time of the query time window. <span class="li-normal">type: str</span>  <a id='label6' href="javascript:ContentClick('label7', 'label6');" onmouseover="ContentPreview('label7');" onmouseout="ContentUnpreview('label7');" title="click to collapse or expand..."> more... </a>
 <div id="label7" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">start</span> The start time of the query time window. <span class="li-normal">type: str</span>  <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Get Mitre Attack matrix by technique id
        fortinet.fortianalyzer.faz_eventmgmt_mitreattackmatrix_technique:
          # bypass_validation: false
          # rc_succeeded: [0, -2, -3, ...]
          # rc_failed: [-2, -3, ...]
          techid: <your own value>
          eventmgmt_mitreattackmatrix_technique:
            mitre_domain: <value of string>
            option: <value in [metadata, event-count, incident-count, ...]>
            time_range:
              end: <value of string>
