:source: faz_report_config_chart_variabletemplate.py

:orphan:

.. _faz_report_config_chart_variabletemplate:
...
.. raw:: html
 ...
 <li><span class="li-head">report_config_chart_variabletemplate</span> Config variable-template. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Config variable-template.
        fortinet.fortianalyzer.faz_report_config_chart_variabletemplate:
