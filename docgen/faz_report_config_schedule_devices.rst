:source: faz_report_config_schedule_devices.py

:orphan:

.. _faz_report_config_schedule_devices:
...
.. raw:: html
 ...
 <li><span class="li-head">report_config_schedule_devices</span> - Config devices. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">devices_name</span> - No description for the parameter <span class="li-normal">type: str</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Config devices.
        fortinet.fortianalyzer.faz_report_config_schedule_devices:
