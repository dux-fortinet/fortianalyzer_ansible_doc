:source: faz_report_graphfile_delete.py

:orphan:

.. _faz_report_graphfile_delete:
...
.. raw:: html
 ...
 <li><span class="li-head">report_graphfile_delete</span> - Handle graph files. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">file_name</span> - No description for the parameter <span class="li-normal">type: str</span> <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Handle graph files.
        fortinet.fortianalyzer.faz_report_graphfile_delete:
