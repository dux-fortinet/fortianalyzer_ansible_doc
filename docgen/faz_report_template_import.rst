:source: faz_report_template_import.py

:orphan:

.. _faz_report_template_import:
...
.. raw:: html
 ...
 <li><span class="li-head">report_template_import</span> - Import report templates. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">dev_type</span> - ADOM device type for import templates. <span class="li-normal">type: str</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
