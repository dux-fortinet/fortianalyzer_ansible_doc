:source: faz_report_template_install.py

:orphan:

.. _faz_report_template_install:
...
.. raw:: html
 ...
 <li><span class="li-head">report_template_install</span> - Install report template language packages from files. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">data</span> - Report template config file base64 encoded string. <span class="li-normal">type: str</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.2.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">language</span> - Language name, en, zh, ja etc, filter for installing report template. <span class="li-normal">type: str</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Install report template language packages from files.
